...
export class UserResolver {
  ...
  async login(
    ...
    // This function returns a Promise of LoginResponse

    // Search db to find the user's email
    ...
    // if the user hasn't visited the site for 7 days make them relogin. (Refresh token expires after 7 days)
